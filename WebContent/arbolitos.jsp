...
<br/><br/>
<a href="#" onclick="window.open('/web/crearArbolito.jsp', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=650, height=350'); return false;" style="text-decoration:none">(Crear un nuevo arbolito)</a><br><br>
