...
<html>
<head>
   <title>FUNDACIÓN FEDERICO RESTREPO CARAVAJAL</title>
    <meta name="Description" content="FUNDACIÓN FEDERICO RESTREPO CARAVAJAL">
...
Object [] curso = bAdministrarPublicaciones.getArbolito(id);
%>
...
<table border="0" width="100%" cellpadding="2">
	<tr>   
		<td width="34%"><span class="Estilo3"><span
			class="Estilo4 Estilo8">*</span>Nombre del arbolito:</span></td>
	...
	<tr>   
		<td width="34%"><span class="Estilo3"><span
			class="Estilo4 Estilo8">*</span>Precio:</span></td>
		<td width="66%">
		<input name="precio" type="text" id="precio"
			class="searchfield"  value="<%=curso[3]%>"/></td>
	</tr>	
	
	<tr>   
		<td width="34%"><span class="Estilo3"><span
			class="Estilo4 Estilo8">*</span>Estado:</span></td>
		<td width="66%">
		...
		<script>
							...
							document.getElementById('estado').value = '<%=curso[2]%>'
					</script>
	...
	<tr>
		<td colspan="2"><div align="center"><span id="detalleActualizarDatos">
		  <input class="searchbutton"
			...
			onClick="editarArbolito(<%=id %>); return false;" /> 
	    </span></div></td>
	</tr>
</table>
