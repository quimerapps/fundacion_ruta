...
Object [] curso = bAdministrarPublicaciones.getEstado(id);
%>
...
<table border="0" width="100%" cellpadding="2">
	<tr>   
		<td width="34%"><span class="Estilo3"><span
			class="Estilo4 Estilo8">*</span>Nombre del esatdo:</span></td>
	...
	<tr>   
		<td width="34%"><span class="Estilo3"><span
			class="Estilo4 Estilo8">*</span>Estado inicial ?:</span></td>
		<td width="66%">
		...
		<script>
							...
							document.getElementById('inicial').value = '<%=curso[2]%>';
					</script>
	...
	<tr>
		<td colspan="2"><div align="center"><span id="detalleActualizarDatos">
		  <input class="searchbutton"
			...
			onClick="editarEstado(<%=id %>); return false;" /> 
	    </span></div></td>
	</tr>
</table>
