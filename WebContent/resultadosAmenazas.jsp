...
List<Object[]> cursos = bAdministrarPublicaciones.getAmenazas(id);
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	<tr>
		...
		<td bgcolor="#EE486C">
		<div align="left" style="color:#FFFFFF">AMENAZA</div>
		</td>
		<td bgcolor="#EE486C">
	...
	<tr >
		...
		<td align="center" bgcolor="<%=color %>"><a href="#" onclick="cargarEliminarAmenaza('<%=i[0]%>','<%=id %>'); return false;">Eliminar</a></td>  
