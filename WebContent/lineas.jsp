			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="post">
						...
						<div class="content">
							<h4>Líneas estratégicas</h4>

						
<br/><br/>
<a href="#" onclick="window.open('/web/crearLinea.jsp', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=500, height=350'); return false;" style="text-decoration:none">Crear nueva línea estratégica</a><br><br>
