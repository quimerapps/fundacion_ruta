	...
	total = "0";
			...
			if(hdnGuardarPublicacion!=null && hdnGuardarPublicacion.equals("1")){
			 ...
			 for(int i=1; i<=Integer.parseInt(total); i++){
				 ...
				 String tit = (request.getParameter("titulo"+i));
				 String val = (request.getParameter("valor"+i));
				 
					bAdministrarPublicaciones.actualizarParametro(ide, tit, val);
					actualizo= 1;
			 }
			...
			%>
			<script type="text/javascript">
					alert('NO SE ACTUALIZO LA INFORMACION EN BASE DE DATOS');
			</script>
