			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="post">
						...
						<div class="content">
							<h4>Estados arbolitos</h4>

						
<br/><br/>
<a href="#" onclick="window.open('/web/crearEstadoArbolito.jsp', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=650, height=350'); return false;" style="text-decoration:none">(Crear un nuevo estado)</a><br><br>
