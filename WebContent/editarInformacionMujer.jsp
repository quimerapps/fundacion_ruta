...
<%
	...
	%>
	<script>
		alert("DATOS GENERALES DE LA MUJER FUERON ACTUALIZADOS CON EXITO");
...
Object[] municipioNacimiento = bAdministrarPublicaciones.getCiudadCompleta(""+mujer[6]);
Object[] municipioResidencia = bAdministrarPublicaciones.getCiudadCompleta(""+mujer[28]);



List<Object[]> municipiosNacimiento = bAdministrarPublicaciones.getMunicipios(""+municipioNacimiento[2]);
List<Object[]> municipiosResidencia = bAdministrarPublicaciones.getMunicipios(""+municipioResidencia[2]);

String ideps = "0";
if(mujer[12]!=null && mujer[12].equals("C")){
	ideps = "E";
	
}


if(mujer[12]!=null && mujer[12].equals("S")){
...
List<Object[]> eps_ars = bAdministrarPublicaciones.getEPSARS(ideps);
...
<table border="0" cellspacing="2" cellpadding="2"
										...
										<tr>
											...
											<td colspan="4" style="text-align: left"><strong>Datos generales sociodemográficos mujeres </strong><br /> <br /></td>
										...
										<tr>
											...
											<td><input id="nombres" name="nombres" type="text"
												value="<%=mujer[1] %>" style="width:250px"/></td>
											<td>Apellidos *:</td>
											<td><input id="apellidos" name="apellidos" type="text"
												value="<%=mujer[2] %>" style="width:250px"/></td>
										...
										<tr>
											...
											<script>document.getElementById("tipo_identificacion").value = "<%= mujer[3]%>-<%= mujer[34]%>";</script>
											
											
											</td>
											<td>No. *:</td>
											<td><input id="documento" name="documento" type="text"
												value="<%=mujer[4] %>" style="width:250px"/>
										...
										<tr>
											...
											<td><span id="span_ti2"><input id="cual_tipo_documento" name="cual_tipo_documento" type="text"
												value="<%=mujer[5] %>" style="width:250px"/></span></td>
											<td></td>
										...
										<tr>
											...
											<script>document.getElementById("departamento_nacimiento").value = "<%= municipioNacimiento[2]%>";</script>
											...
											<td><span id="span_municipio_nacimiento"><select name="municipio_nacimiento" id="municipio_nacimiento" style="width:250px">
																<option value="" selected>Seleccione...</option>
																<%  if (municipiosNacimiento!=null && municipiosNacimiento.size() > 0) {
																	for(Object[] c: municipiosNacimiento){
																		%>
											...
											<script>document.getElementById("municipio_nacimiento").value = "<%= mujer[6]%>";</script>
										...
										<tr>
											...
											<td><input name="fecha_nacimiento" id="fecha_nacimiento" class="texto"
												...
												readonly="true" 
												value="<%=mujer[7] %>" /> <img id="cal" name="cal" 
											...
											<td><input name="edad" id="edad" class="texto"
												...
												readonly="true" " 
												 /><script type="text/javascript">calcularEdad();</script></td>
										</tr>
										...
										<tr>
											...
											<script>document.getElementById("sexo").value = "<%= mujer[10]%>";</script>
											...
											<script>document.getElementById("genero").value = "<%= mujer[11]%>";</script>
											</td>
										</tr>
										...
										<tr>
											...
											<script>document.getElementById("estado_civil").value = "<%= mujer[8]%>-<%= mujer[35]%>";</script>
											</td>
											<td>Etnia *:</td>
											...
											<script>document.getElementById("etnia").value = "<%= mujer[15]%>";</script>
										...
										<tr>
											...
											<td><span id="span_ec2"><input id="cual_estado_civil" name="cual_estado_civil" type="text"
												value="<%=mujer[9] %>" style="width:250px"/></span></td>
											<td></td>
										...
										<tr>
											...
											<script>document.getElementById("regimen").value = "<%= mujer[12]%>";</script>
											...
											<td><span id="span_eps_ars"><select name="eps_ars" id="eps_ars" style="width:250px" onchange="cambiarVisibilidadEpsArs()">
													<option value="" selected>Seleccione..</option>
													<%  if (eps_ars!=null && eps_ars.size() > 0) {
															for(Object[] c: eps_ars){
																%>
											...
											<script>document.getElementById("eps_ars").value = "<%= mujer[13]%>-<%= mujer[36]%>";</script>
										...
										<tr>
											...
											<td><span id="span_eps2"><input id="cual_eps_ars" name="cual_eps_ars" type="text"
												value="<%=mujer[14] %>" style="width:250px"/></span></td>
											<td></td>
											<td><script type="text/javascript">cambiarVisibilidadEpsArs();</script></td>
										...
										<tr>
											...
											<td ><input id="profesion" name="profesion" type="text"
												value="<%=mujer[16] %>" style="width:250px"/></td>
												<td></td>
												<td></td>
										...
										<tr>
											...
											<script>document.getElementById("cabeza_hogar").value = "<%= mujer[17]%>";</script>
											...
											<script>document.getElementById("subsidio").value = "<%= mujer[18]%>";</script>
										...
										<tr>
											...
											<td ><span id="span_subsidio2" style="color:black;"><input id="cual_subsidio" name="cual_subsidio" type="text"
												value="<%=mujer[19] %>" style="width:250px"/></span></td>
												<td></td>
										...
										<tr>
											...
											<td><input id="hijas" name="hijas" type="text"
												value="<%=mujer[20] %>" style="width: 30px" /></td>
											<td>Número Hijos *:</td>
											<td><input id="hijos" name="hijos" type="text"
												value="<%=mujer[21] %>" style="width: 30px" /></td>
										</tr>
										...
										<tr>
											...
											<td colspan="2" ><input type="checkbox" name="rango_edad4" id="rango_edad4" value="S"> 15-21 años <input type="checkbox" name="rango_edad5" id="rango_edad5" value="S"> Mayores de 21 años
											<% if(mujer[22].equals("S")){ %>
											<script type="text/javascript">document.getElementById("rango_edad1").checked = true; </script>
											<% } %>
											<% if(mujer[23].equals("S")){ %>
											<script type="text/javascript">document.getElementById("rango_edad2").checked = true; </script>
											<% } %>
											<% if(mujer[24].equals("S")){ %>
											<script type="text/javascript">document.getElementById("rango_edad3").checked = true; </script>
											<% } %>
											<% if(mujer[25].equals("S")){ %>
											<script type="text/javascript">document.getElementById("rango_edad4").checked = true; </script>
											<% } %>
											<% if(mujer[26].equals("S")){ %>
											<script type="text/javascript">document.getElementById("rango_edad5").checked = true; </script>
											<% } %>
											</td>
										...
										<tr>
											...
											<script>document.getElementById("departamento_residencia").value = "<%= municipioResidencia[2]%>";</script>
											</td>
											...
											<td><span id="span_municipio_residencia"><select name="municipio_residencia" id="municipio_residencia" style="width:250px">
																<option value="" selected>Seleccione...</option>
																<%  if (municipiosResidencia!=null && municipiosResidencia.size() > 0) {
																	for(Object[] c: municipiosResidencia){
																		%>
																		<option value="<%=c[0]%>"><%=c[1]%></option>
																		<%
											...
											<script>document.getElementById("municipio_residencia").value = "<%= mujer[28]%>";</script>
											</td>
										</tr>
										<tr>
											<td>Dirección *:</td>
											<td><input id="direccion" name="direccion" type="text"
												value="<%=mujer[27] %>" style="width:250px"/></td>
											<td>Teléfono(s) *:</td>
											<td><input id="telefonos" name="telefonos" type="text"
												value="<%=mujer[29] %>"  style="width:250px"/></td>
										</tr>
										<tr>
											<td>Correo electrónico:</td>
											<td><input id="correo" name="correo" type="text"
												value="<%=mujer[30] %>"  style="width:250px"/></td>
											<td></td>
											<td></td>
										...
										<tr>
											...
											<script>document.getElementById("liderazgo").value = "<%= mujer[31]%>";</script>
											...
											<td><table><tr><td><select name="anos_liderazgo" id="anos_liderazgo" style="width: 80px" >
													...
													%>
												</select><script>document.getElementById("anos_liderazgo").value = "<%= mujer[32]%>";</script></td><td><select name="meses_liderazgo" id="meses_liderazgo" style="width: 80px" >
													...
													%>
												</select><script>document.getElementById("meses_liderazgo").value = "<%= mujer[33]%>";</script></td></tr>
												</table>
