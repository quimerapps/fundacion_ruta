...
<input type="hidden" value="<%=encuesta%>" name="encuesta" id="encuesta"> 
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="post">
						...
						<div class="content">
							<h4>Encuesta: <%=bAdministrarPublicaciones.getNombreEncuesta(encuesta)[1] %><br>
...
<br>
<input
									type="button" value=" REGRESAR " onclick="document.form1.action='preguntas.jsp?&id=<%=encuesta %>'; document.form1.submit(); " />
	    </center>
