...
if(hdnGuardarPublicacion!=null && hdnGuardarPublicacion.equals("1")){
 ...
 for(int i=1; i<=Integer.parseInt(total); i++){
	 ...
	 String ide = (request.getParameter("parametro"+i));
	 String val = (request.getParameter("valor"+i));
	 
	 bAdministrarPublicaciones.actualizarFinanciadorC(ide, val);
	 actualizo= 1;
 }
...
<script type="text/javascript">
		alert('PORCENTAJES ACTUALIZADOS CON EXITO');
</script>
...
%>
<script type="text/javascript">
		alert('NO SE ACTUALIZO LOS PORCENTAJES EN BASE DE DATOS');
</script>
