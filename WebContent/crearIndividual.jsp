...
List<Object[]> cursos = bAdministrarPublicaciones.getIndividuales();
%>
<form method="post" name="form1" id="form1">  
<table border="0" width="100%" cellpadding="2">
	<tr>   
		<td width="34%"><span class="Estilo3"><span
			class="Estilo4 Estilo8">*</span>Impacto individual:</span></td>
		<td width="66%">
	...
	<tr>
		<td colspan="2"><div align="center"><span id="detalleActualizarDatos">
		  <input class="searchbutton"
			...
			onClick="nuevoIndividual('<%=id%>'); return false;" /> 
	    </span></div></td>
	</tr>
</table>
