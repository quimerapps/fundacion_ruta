...
List<Object[]> cursos = bAdministrarPublicaciones.getColectivos();
%>
<form method="post" name="form1" id="form1">  
<table border="0" width="100%" cellpadding="2">
	<tr>   
		<td width="34%"><span class="Estilo3"><span
			class="Estilo4 Estilo8">*</span>Impacto colectivo/organizativo:</span></td>
		<td width="66%">
	...
	<tr>
		<td colspan="2"><div align="center"><span id="detalleActualizarDatos">
		  <input class="searchbutton"
			...
			onClick="nuevoColectivo('<%=id%>'); return false;" /> 
	    </span></div></td>
	</tr>
</table>
