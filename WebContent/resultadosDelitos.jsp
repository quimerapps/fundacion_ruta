...
List<Object[]> cursos = bAdministrarPublicaciones.getDelitos(id);
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	<tr>
		...
		<td bgcolor="#EE486C">
		<div align="left" style="color:#FFFFFF">DELITO</div>
		</td>
		<td bgcolor="#EE486C">
	...
	<tr >
		...
		<td align="center" bgcolor="<%=color %>"><a href="#" onclick="cargarEliminarDelito('<%=i[0]%>','<%=id %>'); return false;">Eliminar</a></td>  
...
%>
Aún no existen delitos asignados al caso
<%
	}
%>
