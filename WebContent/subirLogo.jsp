...
<p class="Estilo4">&nbsp;</p>
<p class="Estilo4">&nbsp;</p>
<p class="Estilo4">Seleccione el logo que desea (formatos de imágenes aceptados: jpg, png, gif, jpeg):</p>
<form action="recibirLogo.jsp?id=<%=id%>" method="post" enctype="multipart/form-data" name="frm_cargar">
        <p>
