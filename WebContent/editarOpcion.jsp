...
Object[] opcion = bAdministrarPublicaciones.getOpcion(id);  
%>
...
<table border="0" width="100%" cellpadding="2">
	...
	<tr>
		...
		<script>
					document.getElementById('aclarar').value="<%=opcion[3]%>";
	...
	<tr>
		<td ><div align="center"><span id="detalleActualizarDatos">
		  <input class="searchbutton"
			...
			onClick="editarOpcion('<%=id%>'); return false;" /> 
	    </span></div></td>
	</tr>
</table>
