...
function graficaT(identificador) {
	var chart;
	var datos;
	var ejex;
	var ejey;
	...
	ejey = "NUMERO DE MUJERES";
	ejex="OPCIONES DE RESPUESTA";
	titulo="NUMERO DE MUJERES QUE SELECCIONARON OPCION DE RESPUESTA";
	
	

	for(i=1; i<=parseInt(document.getElementById('numero_opciones'+identificador).value); i++){
	
		datos = datos + "<set label='"+ i +")' name='nombreX"+i+"' value='" + parseInt(document.getElementById('opcion'+identificador+'-'+i).value) + "' isSliced='0'/>";											 
	
	}



	chart = new FusionCharts("graficas/Column3D.swf", "chart_div"+identificador, "500", "280", "0", "0");
	...
	chart.render("chart_div"+identificador);
