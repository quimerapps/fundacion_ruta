...
function editarEstado(id) {
	...
	if (document.getElementById('txtCurso').value.replace(/^\s*|\s*$/g, "") == "") {
		mensaje = mensaje + "* Escriba el nombre del estado\n";
	}
	
	
	
	
	if (document.getElementById('inicial').value.replace(/^\s*|\s*$/g, "") == "") {
		mensaje = mensaje + "* Seleccione si el estado corresponde a un estado inicial de los arbolitos.\n";
	}

	if (mensaje.replace(/^\s*|\s*$/g, "") == "") {
		cargarEditarEstado(id);
...
function editarArbolito(id) {

	var mensaje = "";

	if (document.getElementById('txtCurso').value.replace(/^\s*|\s*$/g, "") == "") {
		mensaje = mensaje + "* Escriba el nombre del arbolito\n";
	}
	
	if (document.getElementById('precio').value.replace(/^\s*|\s*$/g, "") == "") {
		mensaje = mensaje + "* Escriba el precio del arbolito\n";
	}
	
	
	if (document.getElementById('estado').value.replace(/^\s*|\s*$/g, "") == "") {
		mensaje = mensaje + "* Seleccione el estado actual del arbolito\n";
	}

	if (mensaje.replace(/^\s*|\s*$/g, "") == "") {
		cargarEditarArbolito(id);
...
function nuevoEstado() {
	...
	if (document.getElementById('inicial').value.replace(/^\s*|\s*$/g, "") == "") {
		mensaje = mensaje + "* Seleccione si es o no el estado inicial\n";
	}
...
function cargarEditarEstado(id) {
	ajax = nuevoAjax();
	parametros = "id="+id+"&c="
			+ encodeURIComponent(document.getElementById("txtCurso").value)+"&inicial="+encodeURIComponent(document.getElementById("inicial").value);
	url = "/web/nuevaEdicionEstado.jsp";
	ajax.onreadystatechange = function() {
		if (ajax.readyState == 1) {
			document.getElementById('detalle').innerHTML = "<img src='images/ajax/ajax-loader3.gif'> ";
		} else if (ajax.readyState == 4) {
			if (ajax.status == 200) {
				...
				if (parseInt(document.getElementById("hdnExito").value) == 1) {
					...
					alert('NO SE PUEDE EDITAR EL ESTADO');
				}
...
function cargarEditarArbolito(id) {
	ajax = nuevoAjax();
	parametros = "id="+id+"&c="
			+ encodeURIComponent(document.getElementById("txtCurso").value)+"&precio="+encodeURIComponent(document.getElementById("precio").value)+"&estado="+encodeURIComponent(document.getElementById("estado").value);
	url = "/web/nuevaEdicionArbolito.jsp";
	ajax.onreadystatechange = function() {
		if (ajax.readyState == 1) {
			document.getElementById('detalle').innerHTML = "<img src='images/ajax/ajax-loader3.gif'> ";
		} else if (ajax.readyState == 4) {
			if (ajax.status == 200) {
				...
				if (parseInt(document.getElementById("hdnExito").value) == 1) {
					alert('ARBOLITO EDITADO CON EXITO');
					...
					alert('NO SE PUEDE EDITAR EL ARBOLITO');
				}
...
function cargarCrearEstado() {
	ajax = nuevoAjax();
	parametros = "c=1";//+ encodeURIComponent(document.getElementById("txtCurso").value)+"&inicial="+encodeURIComponent(document.getElementById("inicial").value);
	url = "/web/nuevaCreacionEstado.jsp";
	ajax.onreadystatechange = function() {
		if (ajax.readyState == 1) {
			document.getElementById('detalle').innerHTML = "<img src='images/ajax/ajax-loader3.gif'> ";
		} else if (ajax.readyState == 4) {
			if (ajax.status == 200) {
				...
				if (parseInt(document.getElementById("hdnExito").value) == 1) {
					alert('ESATDO PARA ARBOLITOS CREADO CON EXITO');
					window.opener.cargarEstados();
					try {
						window.opener.document.form1.submit();
					} catch (e) {
					}
					...
					alert('NO SE PUEDE CREAR EL ESTADO PARA LOS ARBOLITOS');
				}
...
function cargarCrearElEstado() {
	ajax = nuevoAjax();
	parametros = "c="+encodeURIComponent(document.getElementById("txtCurso").value)+"&inicial="+encodeURIComponent(document.getElementById("inicial").value);
			
	url = "/web/nuevaCreacionEstado2.jsp";
	ajax.onreadystatechange = function() {
		if (ajax.readyState == 1) {
			document.getElementById('detalle').innerHTML = "<img src='images/ajax/ajax-loader3.gif'> ";
		} else if (ajax.readyState == 4) {
			if (ajax.status == 200) {
				...
				if (parseInt(document.getElementById("hdnExito").value) == 1) {
					...
					alert('NO SE PUEDE CREAR EL ESTADO');
				}
...
function cargarCrearArbolito() {
	ajax = nuevoAjax();
	parametros = "c="
			+ encodeURIComponent(document.getElementById("txtCurso").value)+"&estado="+encodeURIComponent(document.getElementById("estado").value)+"&precio="+encodeURIComponent(document.getElementById("precio").value);
	url = "/web/nuevaCreacionArbolito.jsp";
	ajax.onreadystatechange = function() {
		if (ajax.readyState == 1) {
			document.getElementById('detalle').innerHTML = "<img src='images/ajax/ajax-loader3.gif'> ";
		} else if (ajax.readyState == 4) {
			if (ajax.status == 200) {
				...
				if (parseInt(document.getElementById("hdnExito").value) == 1) {
					alert('ARBOLITO CREADO CON EXITO');
					window.opener.cargarArbolitos();
					try {
						window.opener.document.form1.submit();
					} catch (e) {
					...
					alert('NO SE PUEDE CREAR EL ARBOLITO');
				}
...
function cargarEliminarImagenEdad(admin, curso) {

	if (confirm('REALMENTE DESEA ELIMINAR EL REGISTRO DE EDAD DEL ARBOLITO ?')) {
		ajax = nuevoAjax();
		parametros = "id=" + admin;
		url = "/web/eliminarEdad.jsp";
		ajax.onreadystatechange = function() {
			if (ajax.readyState == 1) {
				document.getElementById('detalleProcesos').innerHTML = "<img src='images/ajax/ajax-loader3.gif'> Eliminando espere un momento...";
			} else if (ajax.readyState == 4) {
				if (ajax.status == 200) {
					...
					if (parseInt(document.getElementById('hdnElimino').value) == 1) {
						alert('REGISTRO DE EDAD DEL ARBOLITO ELIMINADO CON EXITO');
						cargarEdades(curso);

					} else {
						alert('NO SE PUEDE ELIMINAR EL REGISTRO DE EDAD DEL ARBOLITO PUES TIENE ASOCIADO CONTENIDO.');
...
function cargarEliminarImagen(admin, curso) {

	if (confirm('REALMENTE DESEA ELIMINAR LA IMAGEN DEL ARBOLITO?')) {
		ajax = nuevoAjax();
		parametros = "id=" + admin;
		url = "/web/eliminarImagen.jsp";
		ajax.onreadystatechange = function() {
			if (ajax.readyState == 1) {
				document.getElementById('detalleProcesos').innerHTML = "<img src='images/ajax/ajax-loader3.gif'> Eliminando espere un momento...";
			} else if (ajax.readyState == 4) {
				if (ajax.status == 200) {
					...
					if (parseInt(document.getElementById('hdnElimino').value) == 1) {
						alert('IMAGEN DEL ARBOLITO ELIMINADA CON EXITO');
						cargarImagenes(curso);

					} else {
						alert('NO SE PUEDE ELIMINAR LA IMAGEN DEL ARBOLITO PUES TIENE ASOCIADO CONTENIDO.');
...
function cargarEliminarEstado(admin) {

	if (confirm('REALMENTE DESEA ELIMINAR EL ESTADO?')) {
		ajax = nuevoAjax();
		parametros = "id=" + admin;
		url = "/web/eliminarEstado.jsp";
		ajax.onreadystatechange = function() {
			if (ajax.readyState == 1) {
				document.getElementById('detalleProcesos').innerHTML = "<img src='images/ajax/ajax-loader3.gif'> Eliminando espere un momento...";
			} else if (ajax.readyState == 4) {
				if (ajax.status == 200) {
					...
					if (parseInt(document.getElementById('hdnElimino').value) == 1) {
						alert('ESTADO ELIMINADO CON EXITO');
						cargarEstados();
						
					} else {  
						
						alert('NO SE PUEDE ELIMINAR EL ESTADO PUES TIENE ASOCIADO CONTENIDO.');
...
function cargarEliminarArbolito(admin) {

	if (confirm('REALMENTE DESEA ELIMINAR EL ARBOLITO?')) {
		ajax = nuevoAjax();
		parametros = "id=" + admin;
		url = "/web/eliminarArbolito.jsp";
		ajax.onreadystatechange = function() {
			if (ajax.readyState == 1) {
				document.getElementById('detalleProcesos').innerHTML = "<img src='images/ajax/ajax-loader3.gif'> Eliminando espere un momento...";
			} else if (ajax.readyState == 4) {
				if (ajax.status == 200) {
					...
					if (parseInt(document.getElementById('hdnElimino').value) == 1) {
						alert('ARBOLITO ELIMINADO CON EXITO');
						cargarArbolitos();

					} else {
						alert('NO SE PUEDE ELIMINAR EL ARBOLITO PUES TIENE ASOCIADO CONTENIDO.');
...
function cargarEdades(curso) {
	ajax = nuevoAjax();

	url = "/web/resultadosEdadesArbolitos.jsp";
	parametros = "id=" + curso;
	ajax.onreadystatechange = function() {
		if (ajax.readyState == 1) {
			document.getElementById('detalleAdministradores').innerHTML = "<img src='images/ajax/ajax-loader3.gif'>";
...
function cargarImagenes(curso) {
	ajax = nuevoAjax();

	url = "/web/resultadosImagenesArbolitos.jsp";
	parametros = "id=" + curso;
	ajax.onreadystatechange = function() {
		if (ajax.readyState == 1) {
			document.getElementById('detalleAdministradores').innerHTML = "<img src='images/ajax/ajax-loader3.gif'>";
...
function cargarArbolitos() {
	ajax = nuevoAjax();
	url = "/web/resultadosArbolitos.jsp";
	ajax.onreadystatechange = function() {
		if (ajax.readyState == 1) {
			document.getElementById('detalleAdministradores').innerHTML = "<img src='images/ajax/ajax-loader3.gif'>";
		} else if (ajax.readyState == 4) {
