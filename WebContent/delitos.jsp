			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="post">
						...
						<div class="content">
							<h4>Delitos del caso: <%=nombreCurso %></h4>

<br/><br/>
<a href="#" onclick="window.open('/web/crearDelito.jsp?id=<%=curso %>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=500, height=350'); return false;" style="text-decoration:none">(Ingresar nuevo delito)</a><br><br>
