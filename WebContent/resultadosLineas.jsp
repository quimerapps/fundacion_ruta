...
List<Object[]> cursos = bAdministrarPublicaciones.getLineas();
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	...
	<tr >
		...
		<td align="center" bgcolor="#EEEEEE"><a href="#" onclick="cargarEliminarLinea('<%=i[0]%>'); return false;">Eliminar</a></td>  
...
%>
Aún no existen líneas estratégicas creadas en el sistema
<%
	}
%>
