	...
	if (isMultipart == true) { //valida q si haya un archivo para subir
		...
		while (iter.hasNext()) {
			...
			if (item2.isFormField()) {
				...
				if (ext.equals("JPG") || ext.equals("GIF") || ext.equals("PNG")  || ext.equals("JPEG")   || ext.equals("PDF") || ext.equals("DOC") || ext.equals("DOCX")  || ext.equals("XLS") || ext.equals("XLSX") || ext.equals("PPT") || ext.equals("PPTX") || ext.equals("PPS") || ext.equals("PPSX") || ext.equals("ZIP") || ext.equals("RAR") || ext.equals("7Z")) {//valida q extensiones puedo subir
	...
	//i=nombres.length;
								...
								if (i == nombres.length - 1) {
									if (sizeInBytes <= tamano_maximo_archivo) {
										...
										File uploadedFile = new File(directorio_ruta + "tema_id-"+id+"."+ext.toLowerCase());
...
%>
<script>alert('Archivo cargado con éxito, se cerrará la ventana. Si esto no sucede haga clic en el botón cerrar'); 
try{
...
%><script language="javascript">window.alert("Solo se pueden cargar los formatos indicados");</script>
