...
<br/><br/>
<a href="#" onclick="window.open('/web/crearMC.jsp', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=970, height=600'); return false;" style="text-decoration:none">(Ingresar nuevo caso)</a><br><br>
