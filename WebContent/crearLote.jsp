				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="post">
							...
							<div class="content">
								<h4>NUEVA HOJA DE VIDA MUJERES FUNDACIÓN</h4>
								<div align="left">
									<table border="0" cellspacing="2" cellpadding="2"
										...
										<tr>
											...
											<td><select name="control14" id="control14"
												onchange="esconderComuna();">
													<option value="B" selected>BARRIO</option>
										...
										<tr>
											...
											<td>Años: <input id="control21" name="control21"
												type="text" value="" style="width: 30px" />, Meses: <input
												id="control22" name="control22" type="text" value=""
												style="width: 30px" />
											</td>
												...
												<table style="width: 100%" cellpadding="2" cellspacing="2">
													...
													<tr>
														...
														<td style="text-align: center"><input id="control23"
															name="control23" type="text" value="" /></td>
													...
													<tr>
														...
														<td style="text-align: center"><input id="control25"
															name="control25" type="text" value="" /></td>
														<td style="text-align: center"><select
													...
													<tr>
														...
														<td style="text-align: center"><input id="control27"
															name="control27" type="text" value="" /></td>
														<td style="text-align: center"><select
													...
													<tr>
														...
														<td style="text-align: center"><input id="control29"
															name="control29" type="text" value="" /></td>
														<td style="text-align: center"><select
													...
													<tr>
														...
														<td style="text-align: center"><input id="control31"
															name="control31" type="text" value="" /></td>
														<td style="text-align: center"><select
													...
													<tr>
														...
														<td style="text-align: center"><input id="control34"
															name="control34" type="text" value="" /></td>
														<td style="text-align: center"><select
										...
										<tr>
											<td><br /> <br /> <strong>OBERVACIONES</strong>:</td>
											<td colspan="3"><br /> <br /></td>

										</tr>
										<tr>

											<td colspan="4"><textarea cols="100" rows="10" name="control36" id="control36"></textarea></td>
								...
								<input name="hdnUs" id="hdnUs" type="hidden"
									...
									type="button" value=" Guardar " onclick="validarMujer();" /> <br />
								<br /> <br />
