			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="post">
						...
						<div class="content">
							<h4>Impactos individuales del caso: <%=nombreCurso %></h4>

<br/><br/>
<a href="#" onclick="window.open('/web/crearIndividual.jsp?id=<%=curso %>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=500, height=350'); return false;" style="text-decoration:none">(Ingresar nuevo impacto individual)</a><br><br>
...
<br>
<input
									type="button" value=" REGRESAR " onclick="document.form1.action='casos.jsp'; document.form1.submit(); " />
	    </center>
